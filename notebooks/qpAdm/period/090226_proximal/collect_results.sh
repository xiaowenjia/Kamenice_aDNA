...
cd /mnt/archgen/users/xiaowen/Kamenice/1024/Admixtool/qpAdm/1125/period/090226_proximal

of2="qpAdm_KNC_proximal.summary.251125.txt"

refp="Ref1s.pops"

## Target populations
targets="KNC_LBA KNC_EIA KNC_DIA"
