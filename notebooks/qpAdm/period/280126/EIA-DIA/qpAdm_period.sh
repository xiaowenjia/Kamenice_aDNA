...
cd /mnt/archgen/users/xiaowen/Kamenice/1024/Admixtool/qpAdm/1125/period/280126/EIA-DIA
...
## Target populations
targets="KNC_DIA"
ref1s="KNC_LBA KNC_LBA;SND KNC_LBA;Aegean_LBA Dalmatia_MLBA Dalmatia_MLBA;SND KNC_LBA;Dalmatia_MLBA;SND KNC_EIA"
echo ${ref1s} | sed s/" "/"\n"/g > Ref1s.pops
