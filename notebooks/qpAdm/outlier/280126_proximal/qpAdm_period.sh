...
cd /mnt/archgen/users/xiaowen/Kamenice/1024/Admixtool/qpAdm/1125/outlier/280126_proximal
...
## Target populations
targets="KNC203_ss_RM KNC032_ss_RM KNC031_ss_RM KNC213_ss KNC232_ss KNC269_ss"
ref1s="KNC_LBA KNC_EIA KNC_DIA KNC_LBA;SND SND KNC_LBA;Aegean_LBA Dalmatia_MLBA KNC_LBA;Dalmatia_MLBA KNC_LBA;Dalmatia_MLBA;SND Dalmatia_MLBA;SND Turkey_Aegean_Mugla_Degirmendere_Ancient.AG"
echo ${ref1s} | sed s/" "/"\n"/g > Ref1s.pops
