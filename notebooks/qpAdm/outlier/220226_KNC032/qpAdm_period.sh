...
cd /mnt/archgen/users/xiaowen/Kamenice/1024/Admixtool/qpAdm/1125/outlier/220226_KNC032
...
## Target populations
targets="KNC032_ss_RM"
ref1s="Bulgaria_EIA.AG Aegean_LBA KNC_LBA;Bulgaria_EIA.AG"
echo ${ref1s} | sed s/" "/"\n"/g > Ref1s.pops
