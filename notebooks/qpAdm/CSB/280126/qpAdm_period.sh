...
cd /mnt/archgen/users/xiaowen/Kamenice/1024/Admixtool/qpAdm/1125/CSB/280126
...
## Target populations
targets="CSB_IA PLO Albania_Cinamak_BA_IA.AG"
ref1s="KNC_LBA KNC_EIA KNC_DIA KNC_LBA;SND KNC_LBA;Aegean_LBA Dalmatia_MLBA KNC_LBA;Dalmatia_MLBA KNC_LBA;Dalmatia_MLBA;SND Dalmatia_MLBA;SND"
echo ${ref1s} | sed s/" "/"\n"/g > Ref1s.pops
