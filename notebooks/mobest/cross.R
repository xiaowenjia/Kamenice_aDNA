...
samples_projected <- readr::read_csv(
  "/mnt/archgen/users/xiaowen/Kamenice/1024/mobest/para_prep/KNC_projected.csv"
)
...
readr::write_csv(
  kernel_grid,
  file = paste0(
    "/mnt/archgen/users/xiaowen/Kamenice/1024/mobest/para_prep/hpc_crossvalidation021225WE/kernel_grid_",
