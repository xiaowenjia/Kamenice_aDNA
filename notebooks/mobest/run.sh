...
#$ -o //mnt/archgen/users/xiaowen/Kamenice/1024/mobest/para_prep/log      # standard output file or directory
#$ -q archgen.q  # queue
...
singularity exec \
  --bind=/mnt/archgen/users/xiaowen \
  /mnt/archgen/users/xiaowen/Georgia_final/mobest/apptainer_mobest.sif \
  Rscript /mnt/archgen/users/xiaowen/Kamenice/1024/mobest/para_prep/cross.R ${i} ${current_ds} ${current_dt} \
  /
