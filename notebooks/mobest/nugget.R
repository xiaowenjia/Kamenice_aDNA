...
samples_projected <- readr::read_csv("/mnt/archgen/users/xiaowen/Kamenice/1024/mobest/para_prep/KNC_projected.csv")
...
p <- ggplot() +
 ...
 ggsave(
   filename = "/mnt/archgen/users/xiaowen/Kamenice/1024/mobest/para_prep/nugget.png",
   plot = p,
   scale = 2.5, width = 1000, height = 400, units = "px"
 )